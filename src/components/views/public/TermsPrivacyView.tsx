  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 dir-rtl pb-16">
      ...
      <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 text-white rounded-3xl p-8 text-center space-y-2 shadow-md">
        ...
        <p className="text-xs text-slate-300">آخر تحديث: يوليو 2026 - منصة (وياك) للتوصيل السريع</p>
      </div>
      ...
      <div className="bg-white rounded-3xl p-8 border border-slate-200/80 shadow-xs space-y-8 text-slate-800">
        ...
        <div className="space-y-3">
          ...
          <p className="text-xs leading-relaxed text-slate-600">
            أهلاً بك في منصة "وياك". باستخدامك لموقعنا أو تطبيقنا فإنك توافق التزامياً على الشروط والأحكام الآتية. تُعنى المنصة بتقديم خدمات الوساطة الرقمية والتوصيل الفائق من المحلات التجارية المحلية المعتمدة إلى العميل مباشرة.
          </p>
        ...
        <div className="space-y-3">
          ...
          <p className="text-xs leading-relaxed text-slate-600">
            نحن في منصة "وياك" نولي أهمية قصوى لحماية خصوصيتك وأمان بياناتك الشخصية:
          </p>
          <ul className="list-disc list-inside text-xs leading-relaxed text-slate-600 space-y-1.5 pr-2">
        ...
        <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
          <span className="text-[11px] text-slate-400">© 2026 منصة (وياك) (JIHAT Platform). جميع الحقوق محفوظة.</span>
          <button
            onClick={scrollToTop}
