...
import { Bell, CheckCircle2, ShoppingBag, Trash2, ArrowRight } from 'lucide-react';
      ...
      <div className="bg-gradient-to-r from-purple-900 to-indigo-900 text-white rounded-3xl p-6 sm:p-8 space-y-2 shadow-md">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-purple-200">تنبيهات متابعة حالة الطلبات المباشرة والعروض الترويجية الحصرية</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-3xl p-6 border border-slate-200/80 shadow-xs space-y-3">
        {notifications.length === 0 ? (
          <div className="p-8 text-center text-xs text-slate-500 space-y-3">
            <p>لا توجد إشعارات حالية في صندوق الوارد.</p>
            {onNavigate && (
              <button
